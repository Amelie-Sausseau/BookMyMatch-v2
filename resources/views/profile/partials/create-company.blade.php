<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            {{ __('Ajouter mon entreprise') }}
        </h2>
    </header>

    <form method="post" action="{{ route('company') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        @csrf
        @method('post')
        ...
        <div>
            ...
            <x-text-input id="available_seats" name="available_seats" type="number" class="mt-1 block w-full" required autofocus
                autocomplete="available_seats" />
        ...
        <div>
            ...
            <x-text-input id="opening_hours" name="opening_hours" type="text" class="mt-1 block w-full" required autofocus
